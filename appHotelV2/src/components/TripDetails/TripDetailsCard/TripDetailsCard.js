...
<TouchableOpacity
      ...
      style={styles.buttonDisable}  onPress={() => navigation.navigate('HotelsScreen')} >
      <Text style={styles.text}>Ver más Hoteles</Text>
    </TouchableOpacity>
    </TouchableOpacity>
...
<TouchableOpacity
      ...
      style={styles.buttonDisable}  onPress={() => navigation.navigate('Reserva')} >
      <Text style={styles.text}>Realizar Reserva</Text>
    </TouchableOpacity>
    </TouchableOpacity>
    {/** 
          <TouchableOpacity  style={styles.styleB}>
